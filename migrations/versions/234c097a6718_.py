...
Revision ID: 234c097a6718
Revises: 416159c4e639
Create Date: 2019-01-06 18:22:06.305019
...
revision = '234c097a6718'
down_revision = '416159c4e639'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('nama_fakultas', sa.String(length=60), nullable=True),
    ...
    sa.Column('nama_jurusan', sa.String(length=60), nullable=True),
